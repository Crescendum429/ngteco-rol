...
APP_VERSION = "6.1.0"  # semver MAJOR.MINOR.PATCH — bump PATCH en cada commit, MINOR en features grandes, MAJOR en breaking changes
...
from app_routes.reportes_bp import reportes_bp
